...
(* OASIS_START *)
(* DO NOT EDIT (digest: f15c507e75b0aa4a1ffab98145ec1dba) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/hannesm/ocaml-otr";
          synopsis = "Off the record in OCaml";
          description =
            Some [OASISText.Para "OTR implementation purely in OCaml"];
          categories = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [InternalLibrary "otr"; InternalLibrary "tests"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "tests/";
                      bs_compiled_object = Native;
                      bs_build_depends = [InternalLibrary "otr"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_abstract =
                        Some
                          "OCaml-OTR implements Off the record in OCaml. It consists\nof a pure core.";
                      doc_format = OtherDoc;
                      doc_data_files = [];
                      doc_build_tools =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\166\2370i\222\nw\237\1449R\145\198\218+\235";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
