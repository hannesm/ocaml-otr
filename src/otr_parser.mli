...
val parse_header : Cstruct.t -> (Otr_state.version * Otr_packet.message_type * (int32 * int32) option * Cstruct.t) result
...
val parse_data : Cstruct.t -> (Otr_state.version * (int32 * int32) option * bool * int32 * int32 * Cstruct.t * int64 * Cstruct.t * Cstruct.t * Cstruct.t) result
val parse_data_body : Cstruct.t -> (bool * int32 * int32 * Cstruct.t * int64 * Cstruct.t * Cstruct.t * Cstruct.t) result

val parse_query : string -> (Otr_state.version list * string option) result

val parse_tlv : Cstruct.t -> (Otr_packet.tlv_type option * Cstruct.t * Cstruct.t) result
